...
export class Tab {
  ...
  constructor(tab: TabObject) {
    ...
    this.DataPersistentId = JSON.parse(
      tab.extData['extension:treestyletab@piro.sakura.ne.jp:data-persistent-id']
    )
    this.Children = tab.extData[
      'extension:treestyletab@piro.sakura.ne.jp:children'
    ]
      ? JSON.parse(
          tab.extData['extension:treestyletab@piro.sakura.ne.jp:children']
        )
      : []
    this.Ancestors = tab.extData[
      'extension:treestyletab@piro.sakura.ne.jp:ancestors'
    ]
      ? JSON.parse(
          tab.extData['extension:treestyletab@piro.sakura.ne.jp:ancestors']
        )
      : []
    this.FavIcon = tab.extData[
      'extension:treestyletab@piro.sakura.ne.jp:last-effective-favIcon'
    ]
      ? JSON.parse(
          tab.extData[
            'extension:treestyletab@piro.sakura.ne.jp:last-effective-favIcon'
  ...
  get IsCompleted() {
    return this.Children.length == this.ChildrenTabs.length
  }
